...
class JobPostingRepositoryTest {
    ...
    public void findByKeyword() {
        ...
        jobPostingRepository.save(createJobPosting(company1, "백엔드 개발자", 1500, "백엔드 개발자 채용합니다.", "자바, 스프링"));
        jobPostingRepository.save(createJobPosting(company1, "프론트엔드 개발자", 1000, "프론트엔드 개발자 채용합니다.", "자바스크립트"));
        jobPostingRepository.save(createJobPosting(company2, "풀스택 개발자", 3000, "풀스택 개발자 채용합니다.", "리액트, 스프링"));
